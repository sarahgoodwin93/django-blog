...
class TestCollaborateForm(TestCase):
    ...
    def test_name_is_required(self):
        ...
        self.assertFalse(
            form.is_valid(), msg="Name was not provided, but the form is valid")   # noqa
    ...
    def test_email_is_required(self):
        ...
        self.assertFalse(
            form.is_valid(), msg="Email was not provided, but the form is valid")   # noqa
    ...
    def test_message_is_required(self):
        ...
        self.assertFalse(
            form.is_valid(), msg="Message was not provided, but the form is valid")   # noqa
